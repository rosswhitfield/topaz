...
for r in runs:
    ...
    datai_rebinned=BinMD(InputWorkspace=datai,AxisAligned='0',
	    ...
	    BasisVector2='[0,0,L],in 1.644 A^-1,0,0,1',OutputExtents='-10.025,10.025,-25.0625,25.0625,-10.025,10.025',
...
SaveMD("van_histo",workingdir+"10_25_10/vanHisto_401.nxs")
SaveMD("data_histo",workingdir+"10_25_10/dataHisto_401.nxs") 
#symmetryzation
...
SaveMD("out",workingdir+"10_25_10/out_401.nxs")
