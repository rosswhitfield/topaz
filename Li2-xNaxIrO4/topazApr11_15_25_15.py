...
workingdir="/SNS/users/rwp/Li2-xNaxIrO4/15_25_15/"
UBfile="/SNS/users/rwp/Li2-xNaxIrO4/TOPAZ_7421-49.mat"

runs=range(7421,7449)

Load(Filename='TOPAZ_6663',OutputWorkspace='rawVan')
...
for r in runs:
    ...
    data=ConvertToMD(InputWorkspace="raw",QDimensions='Q3D',dEAnalysisMode='Elastic', Q3DFrames='HKL',
        QConversionScales='HKL',LorentzCorrection='1', MinValues='-15.15,-25.25,-15.15',MaxValues='15.15,25.25,15.15')
    dataRebinned=BinMD(InputWorkspace=data,AxisAligned='0',
	    ...
	    BasisVector2='[0,0,L],in 1.644 A^-1,0,0,1',OutputExtents='-15.075,15.075,-25.125,25.125,-15.075,15.075',
    ...
    ConvertToMD(InputWorkspace='van',OutputWorkspace='vanMDE',QDimensions='Q3D',
        ...
        MinValues='-15.15,-25.25,-15.15',MaxValues='15.15,25.25,15.15',SplitInto='2,2,2')
