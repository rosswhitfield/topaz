...
for r in runs:
    ...
    data=ConvertToMD(InputWorkspace="raw",QDimensions='Q3D',dEAnalysisMode='Elastic', Q3DFrames='HKL',
        QConversionScales='HKL',LorentzCorrection='1', MinValues='-10.1,-10.1,-40.4',MaxValues='10.1,10.1,40.4')
    dataRebinned=BinMD(InputWorkspace=data,AxisAligned='0',
	    ...
	    BasisVector2='[0,0,L],in 1.644 A^-1,0,0,1',OutputExtents='-10.05,10.05,-10.05,10.05,-40.2,40.2',
    ...
    ConvertToMD(InputWorkspace='van',OutputWorkspace='vanMDE',QDimensions='Q3D',
        ...
        MinValues='-10.1,-10.1,-40.4',MaxValues='10.1,10.1,40.4',SplitInto='2,2,2')
